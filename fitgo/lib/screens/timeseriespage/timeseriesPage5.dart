...
class TimeseriesPage5 extends StatelessWidget {
  TimeseriesPage5({Key? key}) : super(key: key);

  static const route = '/timeseries5/';
  static const routename = 'TimeseriesPage5';

  @override
  Widget build(BuildContext context) {
    print('${TimeseriesPage5.routename} built');
