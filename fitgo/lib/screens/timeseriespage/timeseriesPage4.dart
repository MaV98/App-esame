...
class TimeseriesPage4 extends StatelessWidget {
  TimeseriesPage4({Key? key}) : super(key: key);

  static const route = '/timeseries4/';
  static const routename = 'TimeseriesPage4';

  @override
  Widget build(BuildContext context) {
    print('${TimeseriesPage4.routename} built');
