...
class TimeseriesPage2 extends StatelessWidget {
  TimeseriesPage2({Key? key}) : super(key: key);

  static const route = '/timeseries2/';
  static const routename = 'TimeseriesPage2';

  @override
  Widget build(BuildContext context) {
    print('${TimeseriesPage2.routename} built');
