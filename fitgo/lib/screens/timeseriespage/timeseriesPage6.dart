...
class TimeseriesPage6 extends StatelessWidget {
  TimeseriesPage6({Key? key}) : super(key: key);

  static const route = '/timeseries6/';
  static const routename = 'TimeseriesPage6';

  @override
  Widget build(BuildContext context) {
    print('${TimeseriesPage6.routename} built');
