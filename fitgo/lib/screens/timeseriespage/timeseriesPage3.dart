...
class TimeseriesPage3 extends StatelessWidget {
  TimeseriesPage3({Key? key}) : super(key: key);

  static const route = '/timeseries3/';
  static const routename = 'TimeseriesPage3';

  @override
  Widget build(BuildContext context) {
    print('${TimeseriesPage3.routename} built');
