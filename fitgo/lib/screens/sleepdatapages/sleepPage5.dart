...
class SleepDataPage5 extends StatelessWidget {
  SleepDataPage5({Key? key}) : super(key: key);

  static const route = '/sleep5/';
  static const routename = 'SleepDataPage5';

  @override
  Widget build(BuildContext context) {
    print('${SleepDataPage5.routename} built');
    Map<dynamic, dynamic> sleep_data =
        ModalRoute.of(context)!.settings.arguments! as Map<String, dynamic>;
    dynamic sleepdata5 = sleep_data['sleep_data'];

    var provider = Provider.of<Dati>(context);
    if (sleepdata5.isNotEmpty) {
      dynamic start = sleepdata5[0]
          .toString()
          .split(' ')[7]
          .toString()
          .substring(
              0, sleepdata5[0].toString().split(' ')[7].toString().length - 1)
          .toString();
      dynamic end = sleepdata5[sleepdata5.length - 1]
          .toString()
          .split(' ')[7]
          .toString()
          .substring(
              0,
              sleepdata5[sleepdata5.length - 1]
                      .toString()
                      .split(' ')[7]
                      .toString()
                      .length -
    ...
    if (sleepdata5.isEmpty) {
      ...
      for (var i = 0; i < sleepdata5.length; i++) {
        var currentElement_wake = sleepdata5[i];
    ...
    if (sleepdata5.isEmpty) {
      ...
      for (var i = 0; i < sleepdata5.length; i++) {
        var currentElement_light = sleepdata5[i];
    ...
    if (sleepdata5.isEmpty) {
      ...
      for (var i = 0; i < sleepdata5.length; i++) {
        var currentElement_deep = sleepdata5[i];
    ...
    if (sleepdata5.isEmpty) {
      ...
      for (var i = 0; i < sleepdata5.length; i++) {
        var currentElement_rem = sleepdata5[i];
    ...
    if (sleepdata5.isEmpty) {
      ...
      for (var i = 0; i < sleepdata5.length; i++) {
        var currentelement = sleepdata5[i];
