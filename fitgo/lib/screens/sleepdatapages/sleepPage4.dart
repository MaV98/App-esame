...
class SleepDataPage4 extends StatelessWidget {
  SleepDataPage4({Key? key}) : super(key: key);

  static const route = '/sleep4/';
  static const routename = 'SleepDataPage4';

  @override
  Widget build(BuildContext context) {
    print('${SleepDataPage4.routename} built');
    Map<dynamic, dynamic> sleep_data =
        ModalRoute.of(context)!.settings.arguments! as Map<String, dynamic>;
    dynamic sleepdata4 = sleep_data['sleep_data'];

    var provider = Provider.of<Dati>(context);
    if (sleepdata4.isNotEmpty) {
      dynamic start = sleepdata4[0]
          .toString()
          .split(' ')[7]
          .toString()
          .substring(
              0, sleepdata4[0].toString().split(' ')[7].toString().length - 5)
          .toString();
      dynamic end = sleepdata4[sleepdata4.length - 1]
          .toString()
          .split(' ')[7]
          .toString()
          .substring(
              0,
              sleepdata4[sleepdata4.length - 1]
                      .toString()
                      .split(' ')[7]
                      .toString()
                      .length -
    ...
    if (sleepdata4.isEmpty) {
      ...
      for (var i = 0; i < sleepdata4.length; i++) {
        var currentElement_wake = sleepdata4[i];
    ...
    if (sleepdata4.isEmpty) {
      ...
      for (var i = 0; i < sleepdata4.length; i++) {
        var currentElement_light = sleepdata4[i];
    ...
    if (sleepdata4.isEmpty) {
      ...
      for (var i = 0; i < sleepdata4.length; i++) {
        var currentElement_deep = sleepdata4[i];
    ...
    if (sleepdata4.isEmpty) {
      ...
      for (var i = 0; i < sleepdata4.length; i++) {
        var currentElement_rem = sleepdata4[i];
    ...
    if (sleepdata4.isEmpty) {
      ...
      for (var i = 0; i < sleepdata4.length; i++) {
        var currentelement = sleepdata4[i];
