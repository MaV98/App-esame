...
class SleepDataPage2 extends StatelessWidget {
  SleepDataPage2({Key? key}) : super(key: key);

  static const route = '/sleep2/';
  static const routename = 'SleepDataPage2';

  @override
  Widget build(BuildContext context) {
    print('${SleepDataPage2.routename} built');
    Map<dynamic, dynamic> sleep_data =
        ModalRoute.of(context)!.settings.arguments! as Map<String, dynamic>;
    dynamic sleepdata2 = sleep_data['sleep_data'];

    var provider = Provider.of<Dati>(context);
    if (sleepdata2.isNotEmpty) {
      dynamic start = sleepdata2[0]
          .toString()
          .split(' ')[7]
          .toString()
          .substring(
      ...
      dynamic end = sleepdata2[sleepdata2.length - 1]
          ...
          .substring(
              0,
              sleepdata2[sleepdata2.length - 1]
                      .toString()
                      .split(' ')[7]
                      .toString()
                      .length -
    ...
    if (sleepdata2.isEmpty) {
      ...
      for (var i = 0; i < sleepdata2.length; i++) {
        var currentElement_wake = sleepdata2[i];
    ...
    if (sleepdata2.isEmpty) {
      ...
      for (var i = 0; i < sleepdata2.length; i++) {
        var currentElement_light = sleepdata2[i];
    ...
    if (sleepdata2.isEmpty) {
      ...
      for (var i = 0; i < sleepdata2.length; i++) {
        var currentElement_deep = sleepdata2[i];
    ...
    if (sleepdata2.isEmpty) {
      ...
      for (var i = 0; i < sleepdata2.length; i++) {
        var currentElement_rem = sleepdata2[i];
    ...
    if (sleepdata2.isEmpty) {
      ...
      for (var i = 0; i < sleepdata2.length; i++) {
        var currentelement = sleepdata2[i];
