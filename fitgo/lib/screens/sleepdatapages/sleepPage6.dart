...
class SleepDataPage6 extends StatelessWidget {
  SleepDataPage6({Key? key}) : super(key: key);

  static const route = '/sleep6/';
  static const routename = 'SleepDataPage6';

  @override
  Widget build(BuildContext context) {
    print('${SleepDataPage6.routename} built');
    Map<dynamic, dynamic> sleep_data =
        ModalRoute.of(context)!.settings.arguments! as Map<String, dynamic>;
    dynamic sleepdata6 = sleep_data['sleep_data'];

    var provider = Provider.of<Dati>(context);
    if (sleepdata6.isNotEmpty) {
      dynamic start = sleepdata6[0]
          .toString()
          .split(' ')[7]
          .toString()
          .substring(
              0, sleepdata6[0].toString().split(' ')[7].toString().length - 5)
          .toString();
      dynamic end = sleepdata6[sleepdata6.length - 1]
          .toString()
          .split(' ')[7]
          .toString()
          .substring(
              0,
              sleepdata6[sleepdata6.length - 1]
                      .toString()
                      .split(' ')[7]
                      .toString()
                      .length -
    ...
    if (sleepdata6.isEmpty) {
      ...
      for (var i = 0; i < sleepdata6.length; i++) {
        var currentElement_wake = sleepdata6[i];
    ...
    if (sleepdata6.isEmpty) {
      ...
      for (var i = 0; i < sleepdata6.length; i++) {
        var currentElement_light = sleepdata6[i];
    ...
    if (sleepdata6.isEmpty) {
      ...
      for (var i = 0; i < sleepdata6.length; i++) {
        var currentElement_deep = sleepdata6[i];
    ...
    if (sleepdata6.isEmpty) {
      ...
      for (var i = 0; i < sleepdata6.length; i++) {
        var currentElement_rem = sleepdata6[i];
    ...
    if (sleepdata6.isEmpty) {
      ...
      for (var i = 0; i < sleepdata6.length; i++) {
        var currentelement = sleepdata6[i];
    ...
    return Consumer<Dati>(builder: (context, sleepdate6, _) {
      return Scaffold(
          appBar: AppBar(
              // automaticallyImplyLeading: true,
              backgroundColor: Colors.deepPurple,
              title: sleepdata6.isNotEmpty
