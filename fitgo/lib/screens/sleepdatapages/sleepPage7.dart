...
class SleepDataPage7 extends StatelessWidget {
  SleepDataPage7({Key? key}) : super(key: key);

  static const route = '/sleep7/';
  static const routename = 'SleepDataPage7';

  @override
  Widget build(BuildContext context) {
    print('${SleepDataPage7.routename} built');
    Map<dynamic, dynamic> sleep_data =
        ModalRoute.of(context)!.settings.arguments! as Map<String, dynamic>;
    dynamic sleepdata7 = sleep_data['sleep_data'];

    var provider = Provider.of<Dati>(context);
    if (sleepdata7.isNotEmpty) {
      dynamic start = sleepdata7[0]
          .toString()
          .split(' ')[7]
          .toString()
          .substring(
              0, sleepdata7[0].toString().split(' ')[7].toString().length - 1)
          .toString();
      dynamic end = sleepdata7[sleepdata7.length - 1]
          .toString()
          .split(' ')[7]
          .toString()
          .substring(
    ...
    if (sleepdata7.isEmpty) {
      ...
      for (var i = 0; i < sleepdata7.length; i++) {
        var currentElement_wake = sleepdata7[i];
    ...
    if (sleepdata7.isEmpty) {
      ...
      for (var i = 0; i < sleepdata7.length; i++) {
        var currentElement_light = sleepdata7[i];
    ...
    if (sleepdata7.isEmpty) {
      ...
      for (var i = 0; i < sleepdata7.length; i++) {
        var currentElement_deep = sleepdata7[i];
    ...
    if (sleepdata7.isEmpty) {
      ...
      for (var i = 0; i < sleepdata7.length; i++) {
        var currentElement_rem = sleepdata7[i];
    ...
    if (sleepdata7.isEmpty) {
      ...
      for (var i = 0; i < sleepdata7.length; i++) {
        var currentelement = sleepdata7[i];
    ...
    return Consumer<Dati>(builder: (context, sleepdate7, _) {
      return Scaffold(
          appBar: AppBar(
              // automaticallyImplyLeading: true,
              backgroundColor: Colors.deepPurple,
              title: sleepdata7.isNotEmpty
