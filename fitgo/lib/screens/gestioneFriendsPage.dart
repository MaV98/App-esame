...
class GestioneFriendsPage extends StatefulWidget {
       List<Object> _listUsers = [];
   int _UserData = 0;
  dynamic stepsCount;
  GestioneFriendsPage({this.stepsCount});
  ...
  static const routename = 'FriendsPage';
   ...
   @override
  State<GestioneFriendsPage> createState() => _situazione(stepsCount: stepsCount);
 }
class _situazione extends State<GestioneFriendsPage> {
     List<Object> _listUsers = [];
   int _UserData = 0;
     dynamic stepsCount;
   _situazione({this.stepsCount});
